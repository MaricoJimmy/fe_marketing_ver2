  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-8 bg-midnight-core overflow-hidden flex flex-col items-center justify-center text-center">
      ...
      <div className="relative z-10 space-y-6 max-w-4xl">
        ...
        >
          <span className="material-symbols-outlined text-4xl text-electric-cyan mb-4 animate-pulse">query_stats</span>
          <p className="text-soft-white/50 italic text-lg">{t('usecases.coming_soon')}</p>
        </div>
      </div>
    </div>
  );
