...
export default function AboutUs() {
  ...
  return (
    <div className="pt-32 pb-20 px-margin-desktop min-h-screen overflow-hidden">
      <AnimatedBackground />
      <div className="max-w-[1440px] mx-auto space-y-xl">
        ...
        <section 
          ref={introRef}
          className="relative glass-card rounded-2xl overflow-hidden border border-surface-border bg-surface-container-lowest/30 p-xl lg:p-24 transition-all duration-[900ms] ease-out"
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center h-full pr-0 lg:pr-4">
              <div className="space-y-5 lg:space-y-6">
                <h2 className="font-display-md text-3xl lg:text-4xl text-white font-bold mb-2 lg:mb-4 leading-tight">
                  {t('about.intro.title')}
                </h2>
        ...
        <section 
          ref={coreValuesRef}
          className="relative glass-card rounded-2xl border border-surface-border bg-surface-container-lowest/30 p-xl lg:p-16 text-center transition-all duration-[900ms] ease-out"
        ...
        <section 
          ref={awardsRef}
          className="relative glass-card rounded-2xl border border-surface-border bg-surface-container-lowest/30 p-xl lg:p-16 transition-all duration-[900ms] ease-out"
        ...
        <section className="relative glass-card rounded-2xl border border-surface-border bg-surface-container-lowest/30 p-xl lg:p-16 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            <h2 className="font-display-md text-3xl md:text-5xl text-white font-bold leading-tight">
              {t('about.cta.title')}
            </h2>
            ...
            <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button onClick={() => navigate('/dung-thu')} className="w-full sm:w-auto px-8 py-3 rounded-full bg-electric-cyan text-background font-title-md font-bold hover:bg-electric-cyan/90 transition-all duration-300 shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]">
                {t('about.cta.btn1')}
              </button>
              <button onClick={() => navigate('/dung-thu')} className="w-full sm:w-auto px-8 py-3 rounded-full border border-electric-cyan text-electric-cyan font-title-md font-bold hover:bg-electric-cyan/10 transition-all duration-300">
                {t('about.cta.btn2')}
              </button>
            </div>
          </div>
