...
export default function CareersPage() {
  ...
  const handleApply = (jobTitle) => {
    ...
    window.location.href = `mailto:hr@udata.ai?subject=${subject}`;
  };
              ...
              >
                ...
                <div className="flex items-center gap-3 shrink-0 mt-4 md:mt-0">
                  <a 
                    ...
                    className="px-5 py-2.5 rounded-xl border border-surface-border hover:bg-white/5 text-on-surface font-medium transition-colors whitespace-nowrap flex items-center justify-center gap-2"
                  >
                    <span className="material-symbols-outlined text-[18px]">open_in_new</span>
                    {t('careers.jobs.btn.view')}
                  </a>
                  <button 
                    onClick={() => handleApply(lang === 'EN' && job.titleEN ? job.titleEN : job.title)}
                    className="px-6 py-2.5 rounded-xl bg-electric-cyan text-midnight-core font-bold hover:bg-[#10F0CB] transition-all hover:scale-105 whitespace-nowrap shadow-[0_0_15px_rgba(34,211,238,0.2)]"
                  >
      ...
      <section className="pb-20 px-margin-desktop relative">
        <div className="max-w-[1000px] mx-auto bg-gradient-to-r from-[#0284c7] to-[#06b6d4] rounded-3xl p-12 md:p-16 text-center text-white shadow-xl relative overflow-hidden">
          ...
          <button 
            ...
            className="bg-white text-[#0284c7] hover:bg-gray-50 px-8 py-4 rounded-xl font-bold font-title-md transition-all hover:scale-105 flex items-center gap-2 mx-auto relative z-10 shadow-lg"
          >
            {t('careers.cta.btn')}
