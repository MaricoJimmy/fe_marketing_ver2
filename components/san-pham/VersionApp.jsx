                    ...
                    <table className="w-full table-auto ">
                        <thead>
                            <tr className='border-b border-gray/20'>
                                ...
                                <th className='px-2 md:px-3 py-1 text-xl text-center text-gray/80 font-semibold'>Basic</th>
                                <th className='px-2 md:px-3 py-1 text-xl text-center text-gray/80 font-semibold'>Pro</th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                            ...
                                            {featureInVersion.isBasic &&
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clipPath="url(#clip0_191_274)">
                                                        <path d="M9 16.1701L5.53 12.7001C5.14 12.3101 4.51 12.3101 4.12 12.7001C3.73 13.0901 3.73 13.7201 4.12 14.1101L8.3 18.2901C8.69 18.6801 9.32 18.6801 9.71 18.2901L20.29 7.71007C20.68 7.32007 20.68 6.69007 20.29 6.30007C19.9 5.91007 19.27 5.91007 18.88 6.30007L9 16.1701Z" fill="#34A853" />
                                                    </g>
                                                    <defs>
