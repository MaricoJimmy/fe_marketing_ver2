            ...
            <div className="col-span-12 lg:col-span-5 h-[250px] md:h-[450px]">
                <div className="relative w-full h-full">
                    <div className="hidden md:block relative w-full h-full blur-3xl">
                        <div className={`absolute top-16 left-1/2 md:left-2/3 lg:left-1/2 w-[200px] h-[200px] rounded-full ${data.color === "green" ? "bg-green-primary" : "bg-orange-primary"}`}>
                        </div>
                        <div className={`absolute top-36 left-24 md:left-36 lg:left-24 w-[250px] h-[250px] rounded-full ${data.color === "green" ? "bg-green-secondary" : "bg-orange-secondary"}`}>
                        </div>
                    </div>
