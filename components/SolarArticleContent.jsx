    ...
    <div className="w-full flex flex-col gap-10 text-[#D1D5DB] text-[17px] leading-[1.8] font-body-md">
      ...
      <div className="bg-[#0A0E14] border-l-4 border-[#22D3EE] border-y border-r border-y-white/10 border-r-white/10 rounded-r-2xl p-6 md:p-8 relative">
        ...
        <ul className="space-y-3">
          {[
            lang === 'EN' ? 'What Uboard monitors in solar systems' : 'Uboard giám sát những gì trong hệ điện mặt trời',
            lang === 'EN' ? 'Connection, control, and dashboard displays' : 'Kết nối, điều khiển và các thông số Dashboard',
            lang === 'EN' ? 'Alerts and operational reports' : 'Cảnh báo tự động và báo cáo vận hành',
            lang === 'EN' ? 'Actual implementation capacity and operational value' : 'Năng lực triển khai thực tế & Giá trị vận hành'
          ].map((point, index) => (
