                        ...
                        <div className='col-span-4'>
                            ...
                            <ul className='mt-8 flex flex-col items-start gap-6 cursor-pointer'>
                                <li className='flex items-center justify-center'>
                                    ...
                                    <a href='tel:+8454321232' className='ml-2 text-gray/80 font-semibold'>+8454321232</a>
                                </li>
                                <li className='flex items-center justify-center'>
                                    ...
                                    <a href='mailto:mail@mail.com' className='ml-2 text-gray/80 font-semibold'>mail@mail.com</a>
                                </li>
                                <li className='flex items-center justify-center'>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span className='ml-2 text-gray/80 font-semibold'>phường Phú La, quận Hà Đông,
                                        Hà Nội</span>
                                </li>
                            </ul>
                        </div>
