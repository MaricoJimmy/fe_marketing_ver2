                    ...
                    <div className='grid grid-cols-4 gap-6'>
                        ...
                        <div className='col-span-1'>
                            ...
                            <ul className='mt-8 flex flex-col items-start gap-6 cursor-pointer'>
                                <li className='w-full'>
                                    <Link href='/tin-tuc'>
                                        <a className='block w-full text-gray/80 font-semibold hover:text-green-secondary duration-200' ariaLabel="Tin tức">Tin tức</a>
                                    </Link>
                                </li>
                                <li className='w-full'>
                                    <div className='text-gray/80 font-semibold hover:text-green-secondary duration-200'>
                                        <Link href="/san-pham/pambu-oee">
                                            <a className='block w-full' ariaLabel="Pambu OEE">Pambu OEE</a>
                                        </Link>
                                    </div>
                                    <div className='mt-6 text-gray/80 font-semibold hover:text-green-secondary duration-200'>
                                        <Link href="/san-pham/pambu-pms">
                                            <a className='block w-full' ariaLabel="Pambu PMS">Pambu PMS</a>
                                        </Link>
                                    </div>
                                </li>
                                <li className='w-full'>
                                    <div className='text-gray/80 font-semibold hover:text-green-secondary duration-200'>
                                        <Link href="/pambu-oee">
                                            <a className='block w-full' ariaLabel="Tài liệu Pambu OEE">Tài liệu Pambu OEE</a>
                                        </Link>
                                    </div>
                                    <div className='mt-6 text-gray/80 font-semibold hover:text-green-secondary duration-200'>
                                        <Link href="/pambu-pms">
                                            <a className='block w-full' ariaLabel="Tài liệu Pambu PMS">Tài liệu Pambu PMS</a>
                                        </Link>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div className='grid grid-cols-4 gap-6'>
                            ...
                            <div className='col-span-4'>
                                ...
                                <ul className='mt-6 cursor-pointer'>
                                    <li className='w-full'>
                                        <Link href='/tin-tuc'>
                                            <a ariaLabel="tin tuc" className='block w-full text-gray/80 font-semibold hover:text-green-secondary duration-200'>Tin tức</a>
                                        </Link>
                                    </li>
