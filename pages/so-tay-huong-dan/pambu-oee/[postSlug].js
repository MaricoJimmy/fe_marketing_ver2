          ...
          <div className="mt-8 grid grid-cols-3 gap-10">
            <div className="col-span-3 lg:col-span-2">
              <div className="mb-6">
                ...
                <p className="mt-6 text-gray/80 text-sm">
                  Ngày xuất bản: {getDate(post.createdAt)}
                </p>
              ...
              <RichText
                ...
                renderers={{
                  h2: ({ children }) => (
                    <h2 className="text-gray font-bold text-2xl my-4">
                      {children}
                    </h2>
                  ),
                  h3: ({ children }) => (
                    <h3 className="text-gray font-bold text-xl my-4">
                      {children}
                    </h3>
                  ),
                  h5: ({ children }) => (
                    <h5 className="text-gray font-bold text-sm my-4">
                      {children}
                    </h5>
                  ),
                  bold: ({ children }) => <strong>{children}</strong>,
                  h4: ({ children }) => (
                    <h4 className="my-4 text-gray font-bold text-xl ">
                      {children}
                    </h4>
                  ),
                  p: ({ children }) => (
              ...
              <div className="w-full bg-white border border-gray/20 p-8 rounded-lg">
                <div className="w-fit">
                  ...
                  <div className="w-full flex">
                    <div
                      className={`mt-2 w-[100px] h-[3px] bg-green-primary`}
                    ></div>
                  </div>
                </div>
                <ul className="mt-6">
